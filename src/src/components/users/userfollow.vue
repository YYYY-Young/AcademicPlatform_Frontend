<template>
 ...
 <div>
        ...
        <div class="main" style="background-color:#f0f1f4">
            <div class="side">
                <div class="f1">
                    <div class="f11">主页管理</div>
                    <router-link to="/user">
                    <a href="#">
                        <div class="f12">个人账户</div>
                    </a >
                    </router-link>
                    <router-link to="/userac">
                    <a href="#">
                        <div class="f13">学术主页</div>
                    </a >
                    </router-link>
                </div>
                <div class="f2">
                    <div class="f21">学术中心</div>
                    <router-link to="/userfollow">
                    <a href="#">
                        <div class="f22">我的关注</div>
                    </a >
                    </router-link >
                    <router-link to="/userclt">
                    <a href="#">
                        <div class="f23">个人收藏</div>
                    </a >
                    </router-link >
                </div>
            </div>
  ...
  data() {
    ...
    methods: {
       ...
       //console.log(this.$store.)
        this.$axios.get('/main-part/api/user/attention/get/'+this.$store.state.user.id).then(resp => {
...
@import '../../assets/css/userfollow.css';
</style>
